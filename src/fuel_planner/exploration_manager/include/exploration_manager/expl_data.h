...
struct ExplorationParam {
  ...
  // Global memory (from VLM value_map) to bias next-goal selection.
  bool use_value_map_memory_;
  string value_map_topic_;
  int global_reorder_k_;
  double value_reward_weight_;
  double low_value_penalty_weight_;
  double value_map_sample_radius_;
};
